...
SHAPEOP_INLINE void EdgeStrainConstraint::project(const Matrix3X &positions, Matrix3X &projections) const {
  ...
  projections.col(idO_) = weight_ * edge;//l * edge;
}
///////////////////////////////////////////////////////////////////////////////
...
SHAPEOP_INLINE ShapeOpScalar EdgeStrainConstraint::getEdgeLength() {
 return rest_;//1.0f / length;
}
///////////////////////////////////////////////////////////////////////////////
/// ///////////////////////////////////////////////////////////////////////////////
SHAPEOP_INLINE EdgeStrainConstraintDir::EdgeStrainConstraintDir(const std::vector<int> &idI,
                                                          Scalar weight,
                                                          const Matrix3X &positions,
...
///////////////////////////////////////////////////////////////////////////////
SHAPEOP_INLINE void EdgeStrainConstraintDir::project(const Matrix3X &positions, Matrix3X &projections) const {
  Vector3 edge = positions.col(idI_[1]) - positions.col(idI_[0]);
  Scalar l = edge.norm();
  edge /= l;
  edge *= rest_;
...
///////////////////////////////////////////////////////////////////////////////
SHAPEOP_INLINE void EdgeStrainConstraintDir::addConstraint(std::vector<Triplet> &triplets, int &idO) const {
  idO_ = idO;
  triplets.push_back(Triplet(idO_, idI_[0], -weight_));// * rest_));
  triplets.push_back(Triplet(idO_, idI_[1], weight_));// * rest_));
  idO += 1;
...
///////////////////////////////////////////////////////////////////////////////
SHAPEOP_INLINE void EdgeStrainConstraintDir::setEdgeLength(Scalar length) {
  rest_ = length;//1.0f / length;
}
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
